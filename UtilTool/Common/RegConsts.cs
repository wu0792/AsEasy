...
namespace UtilTool
{
    ...
    public class RegConsts
    {
        ...
        /// 星期名
        /// </summary>
        public static readonly Dictionary<DayOfWeek, string> WeekName = new Dictionary<DayOfWeek, string>() {
            {DayOfWeek.Monday,"一"},
            {DayOfWeek.Tuesday,"二"},
        ...
        /// </summary>
        public static readonly Regex ChineseRegex = new Regex("^[一-龥]$");

        /// <summary>
        /// 拼音常量
        /// </summary>
        public static readonly int[] PinyinValue = new int[]{-20319,-20317,-20304,-20295,-20292,-20283,-20265,-20257,-20242,-20230,-20051,-20036,-20032,-20026,
        ...
        /// 拼音
        /// </summary>
        public static readonly string[] Pinyin = new string[]{"a","ai","an","ang","ao","ba","bai","ban","bang","bao","bei","ben","beng","bi","bian","biao",
